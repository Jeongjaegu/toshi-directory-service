...
TEST_QUERY = 'Ether'
DAPPS_WITH_QUERY_IN_NAME_SORTED = [x for x in ALL_DAPPS_SORTED if TEST_QUERY in x[1]]
GAMES_AND_COLLECTIBLES_WITH_QUERY_IN_NAME_SORTED = [x for x in GAMES_AND_COLLECTIBLES_SORTED if TEST_QUERY in x[1]]
